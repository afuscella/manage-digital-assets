		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#ManageDigitalAssets-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ManageDigitalAssets-display": {
								"semanticObject": "ManageDigitalAssets",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=digitalassets.assets",
									"url": sap.ui.require.toUrl("digitalassets/assets")
								}
							}
						}
					}
